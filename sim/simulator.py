...
class Simulator():
    ...
    def simulate_transactions(self, transactions: [Transaction]):
        np.random.seed(0)
        ...
        # First get rid of all the transactions which lead to cannonical error
        ...
        # Process all the txs that according to topology could be processed
        while (True):
